...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Ask real career questions, watch executive conversations, and track your career roadmap." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "LaunchPad EIC — Career growth for early-career professionals" },
      { name: "twitter:description", content: "Ask real career questions, watch executive conversations, and track your career roadmap." },
